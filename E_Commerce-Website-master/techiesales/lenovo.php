...
<section class="p1">
  ...
  <div class="mySlides fade">
    ...
    <img src="images/dell1.jpeg" style="width:100%">
...
function showSlides() {
  ...
  setTimeout(showSlides, 3000); // Change image every 2 seconds
		    					...
		    					<div class="col-md-7">
		    						...
		    						<p class="price">INR Rs.53,490</p>
		    						<p><b>Avialability: </b>In Stock</p>
		    						<p><b>Condidtion: </b>NEW</p>
		    						<label><b>Quantity: </b> </label>
		    						<input type="text" value="1">

		    						<a href="fetch_data.php"><button type="submit" class="btn-btn-primary" name="cart">Add to cart</button></a>
                  </form>
		    					</div>
				</div>	
			</div>
